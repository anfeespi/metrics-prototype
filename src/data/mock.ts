...
function generateMetrics(seed: number, scale: number): BotMetrics {
  ...
  return {
    usageRate: {
      ...
      invocations: s(210 + seed * 15),
      topUsers: [
        { user: 'carlos.m', calls: s(32) },
        { user: 'ana.g', calls: s(28) },
        { user: 'luis.r', calls: s(24) },
        { user: 'maria.s', calls: s(19) },
        { user: 'pedro.l', calls: s(15) },
      ],
      byTeam: [
        { team: 'Core', users: s(12 + seed), invocations: s(54 + seed * 3) },
        { team: 'Engineering', users: s(10 + seed * 0.5), invocations: s(42 + seed * 2) },
        { team: 'TAM', users: s(8), invocations: s(35) },
        { team: 'Dashboard', users: s(6), invocations: s(24) },
        { team: 'Support', users: s(5), invocations: s(20) },
        { team: 'KAM', users: s(3), invocations: s(14) },
        { team: 'CEO Office', users: s(2), invocations: s(8) },
        { team: 'Finance', users: s(1), invocations: s(3) },
      ],
      byChannel: [
        { channel: '#product-tech', users: s(18), invocations: s(72) },
        { channel: '#on-call', users: s(12), invocations: s(48) },
        { channel: '#partnerships', users: s(7), invocations: s(31) },
        { channel: '#feature-requests', users: s(6), invocations: s(22) },
        { channel: '#rappi', users: s(4), invocations: s(16) },
      ],
    },
    taskCompletion: {
